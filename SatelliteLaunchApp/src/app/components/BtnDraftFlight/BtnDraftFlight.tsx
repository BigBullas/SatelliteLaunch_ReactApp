...
// TODO: спросить, надо ли убирать кнопку, если админ находится на страницах Модерации полезных нагрузок или на странице Планируемые полёты (убрать)

// TODO: как удалить сформированные заявки (пустые)? Возникает ошибка в БД  - в гугле